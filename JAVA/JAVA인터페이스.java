...
--------------------------------------------------------------------------------
익명 객체 - 이름이 없는 객체 / 필드값, 로컬 변수값, 매개변수값으로 주로 사용됨.
**클래스를 상속하거나 인터페이스를 구현해야만 생성 가능.
new 부모생성자(매개값, ...) { //부모를 상속해서 {}라는 자식클래스를 생성해서 객체를 만든다.
    //필드
    //메서드
}; - 익명 자식 객체(세미클론 필수)
존나 중요함!!!!!! anonymouseClass 패키지 실습 잘 확인하기!!
    
new 인터페이스명() { //인터페이스를 구현하는 클래스를 만들어 객체를 만듬.
    //필드
    //메서드
}; - 익명 구현 객체(세미클론 필수)
